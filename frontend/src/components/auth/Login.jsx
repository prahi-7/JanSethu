...
const Login = () => {
  ...
  // Main login roles.
  // Students use the separate Student Login from the University section.
  const roles = [
    {
      value: 'citizen',
      label: 'Citizen',
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FFF5F2] pt-20 pb-12 px-4">
      <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl p-6 md:p-8 w-full max-w-md border border-[#FFCABE] relative">
        ...
        <Link
          to="/"
          className="absolute top-3 left-3 md:top-4 md:left-4 text-gray-400 hover:text-[#D4A09A] transition-colors flex items-center gap-2 text-xs md:text-sm group"
        >
        ...
        <div className="text-center mb-6 md:mb-8">
          <div className="w-16 h-16 md:w-20 md:h-20 bg-[#FFCABE] rounded-2xl flex items-center justify-center mx-auto mb-3 md:mb-4 shadow-lg shadow-[#FFCABE]/30 hover:shadow-xl transition-all hover:scale-105">
            <span className="text-[#8B5E5E] font-bold text-2xl md:text-3xl">
              JS
            </span>
          </div>
          ...
          <p className="text-xs md:text-sm text-gray-400 mt-1">
            Login to your JanSethu account
          </p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-2 md:gap-3">
              {roles.map((role) => (
                <button
                  ...
                  className={`flex flex-col items-center justify-center gap-1 p-3 md:p-4 rounded-xl border-2 transition-all duration-200 shadow-sm ${
        ...
        <p className="text-center text-gray-500 mt-4 md:mt-6 text-xs md:text-sm">
          ...
          <Link
            to="/register"
            className="text-[#D4A09A] hover:text-[#8B5E5E] font-semibold transition-colors"
          >
            Register here
          </Link>
        </p>
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 text-center">
          ...
          <Link
            to="/university/login"
            className="text-xs md:text-sm text-[#D4A09A] hover:text-[#8B5E5E] font-semibold transition-colors"
          >
            Student Login →
          </Link>
        </div>
