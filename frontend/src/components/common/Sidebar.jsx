    ...
    switch (role) {
      ...
      case 'student':
        return [
          ...
          /*
           * Team Chat cannot directly contain a teamId here,
           * because Sidebar does not know which team the student
           * wants to open.
           *
           * So it takes the student to My Teams.
           * From there they can open the chat for the selected team.
           */
          {
            name: 'Team Chat',
            path: '/student/teams',
      ...
      case 'industry':
        return [
          ...
          {
            name: 'Assign Mentor',
            path: '/industry/assign-mentor/1',
            icon: <FaUserTie />
          },
          {
            name: 'Fund Project',
            path: '/industry/fund/1',
            icon: <FaDollarSign />
          }
        ];
      ...
      >
        <div className="flex flex-col h-full p-4">
          ...
          <div className="flex items-center gap-2 px-4 py-2 mb-4 bg-[#FFF5F2] rounded-xl border border-[#FFCABE] flex-shrink-0">
            ...
            {role === 'student' && (
              <FaUniversity className="text-[#D4A09A]" />
            )}
            ...
            {role === 'industry' && (
              <FaBuilding className="text-[#D4A09A]" />
            )}
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {menuItems.map((item, index) => {
              ...
              /*
               * For Team Chat, /student/teams is intentional.
               * The actual chat is opened from TeamDetail using
               * the real teamId.
               */
